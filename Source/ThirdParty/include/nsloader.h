...
//#endif
	...
	NSLOADER_API bool __stdcall NSVR_CreateSequence(NSVRPlugin ptr, unsigned int handle, char* name, unsigned int loc);
	//Replaced LPSTR with char*
	NSLOADER_API bool __stdcall NSVR_Load(NSVRPlugin ptr, char* param, int fileType);

	//Replaced LPSTR with char*
	NSLOADER_API bool __stdcall NSVR_CreatePattern(NSVRPlugin ptr, unsigned int handle, char* name);

	//Replaced LPSTR with char*
	NSLOADER_API bool __stdcall NSVR_CreateExperience(NSVRPlugin ptr, unsigned int handle, char* name);
	...
	//Replaced LPSTR with char*
	NSLOADER_API bool __stdcall NSVR_InitializeFromFilesystem(NSVRPlugin ptr, char* path);
