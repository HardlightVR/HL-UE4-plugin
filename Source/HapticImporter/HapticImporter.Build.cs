	...
	public HapticImporter(TargetInfo Target)
	{
		...
		*/
		...
		PublicIncludePaths.AddRange(
			new string[] { "HapticImporter/Public" }
			);
		...
		PrivateDependencyModuleNames.AddRange(
			new string[] { "Core", "CoreUObject", "Engine", "Projects", "AssetTools", "UnrealEd", "Json", "JsonUtilities", "ContentBrowser" }
			);

		PrivateIncludePathModuleNames.AddRange(
			new string[] {"AssetTools", "AssetRegistry" });
